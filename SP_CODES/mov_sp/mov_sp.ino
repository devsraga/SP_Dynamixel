...
//  Serial.begin(115200);
  ...
  // Turn off torque when configuring items in EEPROM area
    ...
    dxl.torqueOff(8);
    dxl.setOperatingMode(8, OP_VELOCITY);     //This function changes operating mode of DYNAMIXEL.
    dxl.torqueOn(8);
}
...
void sweep(){
  dxl.setGoalVelocity(8, 5, UNIT_RPM);
  delay(1000);
  DEBUG_SERIAL.print("Present Velocity(rpm) : ");
  DEBUG_SERIAL.println(dxl.getPresentVelocity(8, UNIT_RPM));
  delay(1000); 
}
